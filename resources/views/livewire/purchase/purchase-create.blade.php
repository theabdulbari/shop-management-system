<div class="container mt-3">
    ...
    <form wire:submit.prevent="save">
        ...
        <div class="mb-3">
            ...
            <input type="date" wire:model.lazy="purchase_date" class="form-control">
        </div>
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th>Subtotal</th>
                    <th>
                        <button type="button" wire:click="addProductRow" class="btn btn-success btn-sm">+</button>
                    </th>
                </tr>
            </thead>
            <tbody>
                @foreach($products as $index => $p)
                    <tr wire:key="product-{{ $index }}">
                        ...
                        <td>
                            <input type="date" wire:model.live="products.{{ $index }}.expiry_date" class="form-control">
                        </td>
                        <td>
                        ...
                        <td>
                            <select wire:model.live="products.{{ $index }}.weight_unit" class="form-select">
